...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 [0] = LAYOUT_ortho_5x15(
    ...
    KC_NO,   KC_NO,        KC_NO,        KC_SPC,       MO(1),        LT(3, KC_TAB), KC_SPC,  KC_SPC,  KC_SPC,  KC_SPC,  MO(2),        KC_SPC,       KC_SPC,       KC_SPC,          KC_SPC
 ),
...
// numpad
 [4] = LAYOUT_ortho_5x15(
    ...
    _______, _______, TO(0),   _______, TO(3),   _______, _______, _______, _______, _______, KC_P7,   KC_P8,   KC_P9,   _______, _______,
